"""M2: TransformerClassifier —— 堆 N 层 TransformerBlock 做文本分类。
参考 Harvard NLP Annotated Transformer 的完整 encoder 架构。
"""
import math
import torch
...
class TransformerClassifier(nn.Module):
    """Transformer 编码器文本分类器。

    架构：Embedding + PE + N * TransformerBlock + Pooling + ClassifierHead
